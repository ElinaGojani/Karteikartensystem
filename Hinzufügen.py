...
HinzufuegenButton=Button(master, text='Frage hinzufügen', bg='darkgrey', fg='white', height=1, width=30,font = myFont, pady=1, command = speichereDieKarte ).grid(row=3, column=2)

#Button zum eingeben der Antwort
ZurueckZurForumSeite=Button(master, text='Zurück zum Forum', bg='darkgrey', fg='white', height=1, width=30,font = myFont, pady=1, command = ClickForum ).grid(row=1, column=2)
